...
/** Phase whose controlled byte admission refused platform access. */
public enum class PlatformFontAccessPhase {
...
public enum class PlatformFontAccessDimension {
...
/** Terminal platform access policy refusal, reporting the attempted controlled allocation charge. */
public data class PlatformFontAccessLimitExceeded(
    /** Refused operation phase. */
    public val phase: PlatformFontAccessPhase,
    /** Refused controlled byte dimension. */
    public val dimension: PlatformFontAccessDimension,
    ...
    override val code: String = "font.platform-font-access-limit-exceeded"
    /** Human-readable phase/dimension/charge diagnostic. */
    override val message: String = "Platform access exceeded $dimension during $phase at $observed (maximum $maximum)."

...
- les bitmaps embarqués (`BitmapGlyphIR`, `ALPHA_8`) avec une encre explicite.
...
La démonstration opt-in écrit des images PGM et PPM accompagnées d'un manifeste
...
runner est exclu de `check` ; il ne contient aucun seuil de performance.
